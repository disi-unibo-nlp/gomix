...
# This method is taken from the HPODNets paper.
def get_protein_features_from_ppi_similarity_matrix(similarity_matrix: np.ndarray) -> np.ndarray:
    return _PPMI_matrix(similarity_matrix)
